...
const fetchdata = async ()=>{
    const data = await fetch("https://foodfire.onrender.com/api/restaurants?lat=21.1702401&lng=72.83106070000001&page_type=DESKTOP_WEB_LISTING%22");
...
*/
    ...
    <div className="Body m-[10px] ">
        <div className="filter">
            ...
            <input className="border border-black b-2" value={loggedInUser} onChange={(e)=>{setUserName(e.target.value)}}></input> */}
        </div>
